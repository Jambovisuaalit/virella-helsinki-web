...
const conversionChecks = [
  ["01", "Pääviesti", "Ymmärtääkö asiakas heti, mitä tarjoat ja miksi hänen kannattaa jatkaa?"],
  ["02", "Seuraava askel", "Näkeekö asiakas heti, miten ottaa yhteyttä tai ostaa?"],
  ["03", "Mobiili", "Onko yhteydenotto helppo myös puhelimella?"],
] as const;

const promises = [
  ["690 €", "Kiinteä kertamaksu"],
  ["72 h", "Kun maksu, tiedot ja oikeudet ovat kunnossa"],
          ...
          <SectionContainer className="grid gap-14 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:gap-16">
            <div className="max-w-[760px]">
              <div className="inline-flex items-center gap-2.5 rounded-full border border-brand/15 bg-surface/80 px-3.5 py-2 text-[11px] font-extrabold uppercase tracking-[0.17em] text-brand shadow-[0_10px_26px_-22px_rgba(23,33,38,0.45)] backdrop-blur">
                ...
                Conversion Fix · {euro.format(conversionFix.price)} · toimitus 72 h
              </div>
              ...
              <h1 className="mt-7 max-w-[760px] text-[3.15rem] font-extrabold leading-[0.93] tracking-[-0.065em] text-foreground sm:text-[4.4rem] lg:text-[5.35rem]">
                Sivustosi ei tarvitse aina uusimista. Sen pitää tehdä yhteydenotosta helpompi.
              </h1>

              <p className="mt-7 max-w-[670px] text-[1.05rem] leading-8 text-muted sm:text-[1.16rem]">
                Conversion Fix korjaa nykyisen verkkosivusi kohdat, jotka vaikeuttavat asiakkaan seuraavaa askelta — kiinteällä 690 € hinnalla ilman täyttä verkkosivuprojektia.
              </p>

              <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
                <ButtonLink href="/verkkosivu-kuntoon" className="sm:px-6">Katso mitä korjaamme</ButtonLink>
              ...
              <Card className="soft-ring overflow-hidden border-white/80 bg-surface/95 shadow-[0_36px_100px_-48px_rgba(23,33,38,0.45)] backdrop-blur">
                <div className="flex items-center justify-between border-b border-border/70 px-5 py-4 sm:px-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[11px] font-extrabold uppercase tracking-[0.16em] text-brand">Conversion Fix</p>
                      <p className="mt-0.5 text-sm font-bold text-foreground">Mitä tarkistamme ensin</p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 border-t border-border/70 bg-cloud/55 px-5 py-5 sm:px-6">
                  <div>
                    <p className="text-[10px] font-extrabold uppercase tracking-[0.15em] text-muted">Korjaukset</p>
          ...
          <SectionContainer className="py-20 sm:py-24 lg:py-28">
            <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
              <div>
                ...
                <h2 className="mt-4 max-w-[680px] text-4xl font-extrabold leading-[1.02] tracking-[-0.05em] sm:text-5xl">Aloita näkyvimmästä ongelmasta.</h2>
              </div>
              <p className="max-w-[620px] text-base leading-7 text-muted lg:justify-self-end sm:text-lg">
                Jos verkkosivu on jo olemassa, kaikkea ei tarvitse rakentaa uudelleen. Conversion Fix korjaa ensin ne kohdat, jotka vaikeuttavat asiakkaan yhteydenottoa.
              </p>
            </div>
            ...
            <Card className="mt-12 overflow-hidden border-brand/15 bg-surface shadow-[0_34px_90px_-52px_rgba(23,33,38,0.48)] lg:grid lg:grid-cols-[1.35fr_0.65fr]">
              <div className="relative p-7 sm:p-9 lg:p-11">
                ...
                <p className="mt-5 max-w-[680px] text-base leading-7 text-muted sm:text-lg">Korjaamme nykyisen sivusi tärkeimmät yhteydenottoa vaikeuttavat kohdat. Saat konkreettiset muutokset, ennen/jälkeen-yhteenvedon ja yhden korjauskierroksen ilman täyttä verkkosivuprojektia.</p>
                <div className="mt-7 flex flex-wrap gap-2 text-[11px] font-extrabold text-brand">
                  <span className="rounded-full border border-brand/12 bg-brand/5 px-3.5 py-2">Toimitus 72 h</span>
                  <span className="rounded-full border border-brand/12 bg-brand/5 px-3.5 py-2">8 korjauskohtaa</span>
              ...
              <div className="flex flex-col justify-between border-t border-border/70 bg-cloud/55 p-7 sm:p-9 lg:border-l lg:border-t-0 lg:p-10">
                ...
                <Link href="/verkkosivu-kuntoon" className="mt-8 inline-flex min-h-12 items-center justify-center rounded-full bg-action px-5 py-3 text-sm font-extrabold text-white shadow-[0_12px_30px_-16px_rgba(216,74,36,0.7)] transition hover:-translate-y-0.5 hover:brightness-[0.96]">Katso mitä saat</Link>
              </div>
            </Card>
        ...
        <section id="how" className="relative overflow-hidden bg-brand text-white">
          ...
          <SectionContainer className="relative py-20 sm:py-24 lg:py-28">
            <div className="max-w-[760px]">
              ...
              <h2 className="mt-4 text-4xl font-extrabold tracking-[-0.05em] sm:text-5xl">Kolme vaihetta. Tiedät hinnan ja sisällön ennen ostamista.</h2>
            </div>

            <ol className="mt-12 grid gap-4 md:grid-cols-3">
              {[
                ["01", "Tutustu palveluun", "Näet hinnan, toimitussisällön ja rajaukset ennen päätöstä."],
                ["02", "Maksa turvallisesti verkossa", "Stripe Checkout vahvistaa maksun turvallisesti."],
                ["03", "Täytä aloituskysely", "Anna toteutukseen tarvittavat lähtötiedot. Salasanoja ei kysytä lomakkeella."],
          ...
          <SectionContainer>
            <div className="relative overflow-hidden rounded-[2rem] border border-brand/10 bg-surface px-6 py-10 shadow-[0_30px_90px_-56px_rgba(23,33,38,0.5)] sm:px-10 sm:py-12 lg:px-14 lg:py-14">
              ...
              <div className="relative flex flex-col gap-9 md:flex-row md:items-end md:justify-between">
                <div className="max-w-[760px]">
                  <p className="text-[11px] font-extrabold uppercase tracking-[0.2em] text-brand">Conversion Fix · 690 € · toimitus 72 h</p>
                  <h2 className="mt-4 text-4xl font-extrabold leading-[1.02] tracking-[-0.05em] sm:text-5xl">Tee yhteydenotosta asiakkaalle helpompi.</h2>
                  <p className="mt-5 max-w-[680px] text-base leading-7 text-muted sm:text-lg">Kiinteä 690 € kertamaksu. 72 tunnin toimitusaika alkaa, kun maksu, aloituskysely ja toteutukseen tarvittavat materiaalit tai käyttöoikeudet ovat käytettävissä.</p>
                </div>
                <ButtonLink href="/verkkosivu-kuntoon" className="shrink-0 sm:px-6">Osta Conversion Fix · 690 €</ButtonLink>
              </div>
            </div>
          </SectionContainer>
        </section>
